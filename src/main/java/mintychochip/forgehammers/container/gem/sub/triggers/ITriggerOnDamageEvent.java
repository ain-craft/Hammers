...
public interface ITriggerOnDamageEvent {

  void execute(EntityDamageEvent event, int level);

  default ExecutionPriority getPrio() {
    try {
      Method method = this.getClass().getMethod("execute", EntityDamageEvent.class, int.class);
